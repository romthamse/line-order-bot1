 ...
 * it \u2014 "1 lager", "one lager" \u2014 which is how English speakers naturally
 * order ("number before noun"), as opposed to "lager 1" which is common
 * among Thai speakers ordering in English. Only the token immediately
 * before the product name (ignoring filler words in between, e.g. "please
 * get 1 lager") counts; returns null if nothing number-like is found there.
 */
